...
let c = new MapboxChoropleth({
  tableUrl: 'https://raw.githubusercontent.com/SPadlewski/GIS_code/main/test%20copy.csv', //link to csv
  tableNumericField: 'normalized_price_dif', // column with result
  tableIdField: 'lsoa_code',  // joining csv and geojson lsoa_code column
  geometryUrl: 'https://raw.githubusercontent.com/SPadlewski/GIS_code/main/test_3.geojson', //link to geojson
  ...
  let d = new MapboxChoropleth({
    ...
    geometryUrl: 'https://raw.githubusercontent.com/SPadlewski/GIS_code/main/test_3.geojson',
